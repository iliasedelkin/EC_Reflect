...
var reflection2 = Reflection(id: UUID(), date: Date().addingTimeInterval(-60 * 60 * 24 * 3),
                             notes: "Today the weather is not good, but luckily I took my umbrella. I hate rain.",
                             feeling: .neutral)

var reflection3 = Reflection(id: UUID(), date: Date().addingTimeInterval(-60 * 60 * 24 * 2),
                             notes: "I am  so tired, I should have gone to bed earlier. Deprivation of sleeping is the worst thing.",
                             feeling: .sad)

var reflection4 =  Reflection(id: UUID(), date: Date().addingTimeInterval(-60 * 60 * 24 * 1),
